...
def open_labelled_data(fp_list, already_cleaned):
    ...
    if already_cleaned:
        with open(already_cleaned) as f:
            dat = json.load(f)
...
if __name__ == '__main__':
    ...
    transformer_model_name = 'deepset/gbert-large'
    als = 'NIHDAL'

    sample_list = open_pool(
        '/n/home09/esilcock/stigma-non-take-up/data/raw_data/newspapers/ProQuest_data/germany_chunked.json',
        soft_start_data = 'Labelled_data/other_languages/German_mentions_benefits.json'
        )
